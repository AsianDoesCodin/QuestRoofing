...
write("styles.css", stylesCss + stickyCtaCss + heroSplitCss + mobileHeroCss + imageCardCss + homepageCurrentCss + headerSplitCss + headerLogoCss + headerLogoFitCss + headerSlashCss + headerVisibleSlashCss + headerColorPanelCss + cityProofCardCss + serviceLinkCardCss);
